...
(function testPeepsControllerLoadsPeepsFromAPICall() {
  ...
  var actualHTML = document.getElementById('app').innerHTML;
  var expectedHTML = "<ul><li><div>Test chitter peep number 4</div><div>Posted by: test_user</div></li><br></ul>";
  assert.isTrue(actualHTML === expectedHTML);
